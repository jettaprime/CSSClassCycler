(function(w) {
    ...
    this._listenerHosts.forEach(function(hostSet) {
      hostSet.forEach(function(host, idx) {
        events.forEach(function(e) {
          ...
          host.addEventListener(e, this._handlerRegistry.mouse[listenerIdx], false);
          listenerIdx++;
        }.bind(this));
      }.bind(this));
    }.bind(this));
  ...
  ClassCycler.prototype._addListenersOnWindow = function() {
    ...
    events.forEach(function(event) {
      this._handlerRegistry[event] = ClassCycler.EventHandlers[event].bind(this);
  ...
  ClassCycler.prototype._loop = function(currentTime) {
    ...
    if (!this._halted) {
      this._scheduledFrame = w.requestAnimationFrame(this._loop.bind(this, currentTime));
    }
  };
  ...
  ClassCycler.prototype._removeListenersOnHosts = function() {
    ...
    this._listenerHosts.forEach(function(hostSet) {
      hostSet.forEach(function(host, idx) {
        events.forEach(function(e) {
          host.removeEventListener(e, this._handlerRegistry.mouse[listenerIdx], false);
          listenerIdx++;
        }.bind(this));
      }.bind(this));
    }.bind(this));
